...
namespace WindowsFormsApp1
{
    public partial class frmSelezionePersonaggio : Form
    {
        ...
        private void pbReAp_Click(object sender, EventArgs e)
        {

        }

        private void pbKaiser_Click(object sender, EventArgs e)
        {
        ...
        private void pbZar_Click(object sender, EventArgs e)
        {

        }

        private void pbKing_Click(object sender, EventArgs e)
        {
